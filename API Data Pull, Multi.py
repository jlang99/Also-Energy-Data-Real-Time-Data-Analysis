...
if __name__ == "__main__":
    def my_main():
        ...
        #Dictionary for Storing API DATA in memory for comaprison
        global last_good_api_data
        global row_index
        global wb
        global ws
        global today_date
    ...
    global loop_exit_file, auth_file
    ...
    while True:
        ...
        if count > 4 and count < 10:
            ...
            if wait <= 0:
                wait = 10  
            print(f"Waiting {wait} Seconds then pulling data again")
            time.sleep(wait)
